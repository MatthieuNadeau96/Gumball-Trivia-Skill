...
module.exports = {
    ...
    "QUESTIONS_EN_US" : [
        {
            "A group of toads are called what?": [
                "a knot",
                "a pack",
                "a herd",
                "a squad",
        ...
        {
            "What is the average lifespan for toads?": [
                "3 to 5 years",
                "5 to 10 years",
                "20 to 50 years",
                "1 to 2 years"
        ...
        {
            "What of the following is not true?": [
                "Some toad species can glide from tree to tree",
                "Some toad species are psychoactive",
                "Toads will hibernate throughout the winter",
                "Toads do not have teeth",
                "Toads may sometimes play dead, or puff themselves up to appear bigger if they feel threatened by predators"
            ]
        },
        {
            "In what year did Toad from Super Mario Bros make his first debute?": [
                "1988",
                "1990",
                "2000",
                "1996"
