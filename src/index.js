"use strict";
var APP_ID = "amzn1.ask.skill.646744fc-a5f0-498c-867d-f9b4e56343f7";  // TODO replace with your app ID (OPTIONAL).

var ANSWER_COUNT = 1; // The number of possible answers per trivia question.
var GAME_LENGTH = 20;  // The number of questions per trivia game.
var GAME_STATES = {
...
var languageString = {
    "en": {
        "translation": {
            ...
            "GAME_NAME" : "Gumball Trivia", // Be sure to change this for your skill.
    ...
    "en-US": {
        "translation": {
            "QUESTIONS" : questions["QUESTIONS_EN_US"],
            "GAME_NAME" : "The Amazing World of Gumball Trivia" // Be sure to change this for your skill.
        }
    }
};
